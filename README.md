...
| **Мороз Маргарита** (Напарник) | Архітектура, UI та Конфігурація | 1. Клас `Game`: головний цикл, керування станами (меню, гра, фініш).<br>2. Клас `Config`: парсинг CLI аргументів через `argparse` (вибір траси/складності).<br>3. Клас `InputHandler` та UI: вивід таймера, лічильника кіл. |